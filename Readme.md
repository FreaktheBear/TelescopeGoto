...
3. Allignment and positioning based upon data from a 9-axis MPU and a GPS module. (Update: one MPU poses too much problems getting the correct right ascension / declination data for the NextStar protocol, so I decided to use two MPU6050's for the moment), (Update 2: Feedback control based on the MPU6050s has been dropped. The MPU6050s pose problems in the readout as there are some "blind spots" in the measurements when tilted near 90 degrees)
